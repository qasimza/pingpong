...
from learning import moe_agent
from learning import moe_players
...
def build_alg_runner(algo_observer):
    ...
    runner.algo_factory.register_builder('moe', lambda **kwargs : moe_agent.MOEAgent(**kwargs))
    runner.player_factory.register_builder('moe', lambda **kwargs : moe_players.MOEPlayer(**kwargs))
    runner.model_builder.model_factory.register_builder('moe', lambda network, **kwargs : hrl_models.ModelHRLContinuous(network))  
    runner.model_builder.network_factory.register_builder('moe', lambda **kwargs : hrl_network_builder.HRLBuilder())
