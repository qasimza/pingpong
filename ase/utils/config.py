...
def get_args(benchmark=False):
    custom_parameters = [
        ...
        {"name": "--save_render", "action": "store_true", "default": False,
            "help": "save render image"},
        {"name": "--save_bvh", "action": "store_true", "default": False,
            "help": "save bvh file"},
        {
            "name": "--statistics",
            "action": "store_true",
        ...
        },
        {
            "name": "--motion_file",
            "type": str,
            "default": "ase/data/motions/pingpong_agent2/Transition_looping_FB_blender_pph.npy",
        ...
        },
        {
            ...
            "type": str,
            "default": "any",
            "help": "Can be forehand, backhand, any",
        },
        {
            "name": "--checkpoint",
            "type": str,
        ...
        },
        {
            "name": "--llc_checkpoint",
            "type": str,
            "default": "output/pp_llc_all/nn/Humanoid.pth",
