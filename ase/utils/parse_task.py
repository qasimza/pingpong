...
from env.tasks.humanoid_pp_getup import HumanoidPPGetup
from env.tasks.humanoid_pp_hit_targets import HumanoidPPHitTargets
from env.tasks.humanoid_pp_hit_targets_single import HumanoidPPHitTargetsSingle
from env.tasks.humanoid_view_motion import HumanoidViewMotion
from env.tasks.humanoid_pp_view_motion import HumanoidPPViewMotion
