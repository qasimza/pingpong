...
def project_joints(motion, source_motion):
...
def main():
    ...
    retarget_data_path = "data/configs/retarget_pp_to_pphumanoid.json"
    ...
    target_motion = project_joints(target_motion, source_motion)
